...
const dataSkills = [
  ...
  },
  {
    ...
    knowledgeDetail: "SQL, Oop, java-core, github...",
  },
];
...
export default function Skills() {
  return (
    <ContainerSkill>
      ...
      <div>
        <P className="pb-1">
          Tôi đã có hơn 6 tháng kinh nghiệm trong vị trí Web Developer. Tôi có
          thể làm việc với các framework như: <strong>Reactjs, Jquery</strong>
        </P>
        <div className="row">

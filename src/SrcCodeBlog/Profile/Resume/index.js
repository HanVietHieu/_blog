      ...
      <div className="row px-0">
        <div className="col-12 col-md-6">
          <div className="resume__detail">
            ...
            <h4>Vũ Văn Quý</h4>
            <p>
              Tôi có hơn 6 tháng kinh nghiệm trong vị trí Web Developer. Ngoài
              công việc chuyên môn tôi có niềm đam mê với Guitar, Game, Đá bóng.
            </p>
            <ul>
              <li>Ha Noi, Viet Nam</li>
              <li>vuquy97.vkh@gmail.com</li>
            </ul>
          </div>
          <div className="resume__detail">
            <h3>Education</h3>
            ...
            <ul>
              <li>Chuyên ngành: Kỹ thuật điện tử</li>
              <li>Tốt nghiệp loại khá: 2.8/4</li>
            </ul>
          </div>
        </div>
        <div className="col-12 col-md-6">
          ...
          <div className="resume__detail">
            ...
            <p className="working-time">10/2022 - now</p>
            <ul>
